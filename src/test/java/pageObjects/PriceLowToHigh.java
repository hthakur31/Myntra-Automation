package pageObjects;
	...
	public class PriceLowToHigh extends BasePage{

		 public PriceLowToHigh(WebDriver driver) {
			super(driver);
		    ...
		    @FindBy(xpath="//*[@id=\"desktopSearchResults\"]/div[1]/section/div[1]/div[1]/div/div/div/ul/li[6]/label")
